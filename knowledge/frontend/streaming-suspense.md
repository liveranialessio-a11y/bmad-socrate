...
sources: []
connects_to: [server-vs-client-components, data-fetching-patterns]
pending_review: null
review_failures: 0
applications:
...
React Streaming + Suspense. loading.tsx, error.tsx. Granularità streaming. UX dei loading state.
