...
sources: []
connects_to: [alerting-strategy, audit-log-patterns]
pending_review: null
review_failures: 0
applications:
...
Runbook per scenari comuni. Postmortem blameless format. MTTR (mean time to recover). Comunicazione cliente durante incident.
