...
sources: []
connects_to: [structured-logging, cost-analysis-paas]
pending_review: null
review_failures: 0
applications:
...
Vercel Analytics. Supabase logs (postgres + auth + edge). Cloudflare logs. Leggere dashboard, cosa cercare.
